function getDataCabana() {
    $.ajax({
        type: 'GET',
        url: 'http://129.151.115.27:8080/api/Cabin/all',
        dataType: 'json',
...
function getDataCliente() {
    $.ajax({
        type: 'GET',
        url: 'http://129.151.115.27:8080/api/Client/all',
        dataType: 'json',
...
function consultarReservaTodo() {
    $.ajax({
        url: 'http://129.151.115.27:8080/api/Reservation/all',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function guardarReserva() {
    ...
    $.ajax({
        url: 'http://129.151.115.27:8080/api/Reservation/save',
        data: datosaEnviar,
        type: 'POST',
        dataType: 'json',
